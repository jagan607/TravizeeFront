...
class Wallet extends Component {
    ...
    handleChange = (e) => {
      ...
      var balance = this.state.balance;
        this.setState({credit:e.target.value, balance : balance + Number(e.target.value) })
    };
    render(){
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div style={{ textAlign: "center" }}>
                <button class="button" onClick={() => this.handleSubmit()} style={{ textAlign: "center" }}>Add Money</button>
              </div>
            </>
          )}
